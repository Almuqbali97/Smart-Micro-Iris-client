        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 animate-fadeIn">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Micro-Iris Membrane Analysis</h1>
          ...
          <div className="text-center mt-6 sm:mt-8 px-4">
            <p className="text-xs sm:text-sm text-gray-500 flex items-center justify-center gap-2 flex-wrap">
              ...
              <span>Powered by GPT-4 AI · Smart Micro-Iris Membrane Intelligence System</span>
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50 p-6 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10 px-4 sm:px-6">
        ...
        <div className="text-center mb-6 sm:mb-8 animate-fadeIn">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-700 font-semibold mb-1 px-4">Smart Micro-Iris Membrane Intelligence System</p>
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span className="hidden sm:inline">Design Micro-Iris Membrane</span>
